...
func _on_Button_Pressed():
	...
	#
	get_parent().get_node("Exit_Button_2").visible = true
	get_parent().get_node("Back_To_Main_Menu_Button_3").visible = true
	get_parent().get_node("Back_To_Main_Menu_Button_3").grab_focus()
	get_parent().get_node("Back_Or_Exit_Question_2").visible = true
