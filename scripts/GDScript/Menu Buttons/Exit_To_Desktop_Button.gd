...
func _on_Button_Pressed():
	...
	get_parent().get_node("Back_To_Menu_Button").visible = true
	get_parent().get_node("Exit_To_Desktop_Button_2").visible = true
	
	get_parent().get_node("Back_To_Menu_Button").grab_focus()
