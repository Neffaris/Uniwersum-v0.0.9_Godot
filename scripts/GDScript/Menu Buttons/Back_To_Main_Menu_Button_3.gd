...
func _on_Button_Pressed():
	...
	get_parent().get_node("Back_To_Main_Menu_Button_4").visible = false
	...
	get_parent().get_node("New_Game_Button").visible = true
	get_parent().get_node("New_Game_Button").grab_focus()
	get_parent().get_node("Load_Game_Button").visible = true
	get_parent().get_node("Options_Button").visible = true
	get_parent().get_node("Exit_Button").visible = true
